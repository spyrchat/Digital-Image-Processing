...
def is_rectangle(points, tolerance=1e-1):
    """
    ...
    tolerance (float): Tolerance for comparing distances.
...
def find_rectangles(points, tolerance = 4):
    rectangles = []
    for combination in combinations(points, 4):
        if is_rectangle(combination, tolerance=tolerance):
